...
<form method="post" action="{{ route('contact.confirm') }}">
	...
	<table class="element_wrap">
		<tr>
			...
			<td><input required type="text" name="your_last_name" value="{{ old('your_last_name') }}"></td>
			<td><input required type="text" name="your_first_name" value="{{ old('your_first_name') }}"></td>
		</tr>
		<tr>
			<td></td>
		...
		<tr>
			<td></td>
			@if ($errors->has('your_last_name'))
				<td class="error_message">{{ $errors->first('your_last_name') }}</td>
			@endif
			@if ($errors->has('your_first_name'))
				<td class="error_message">{{ $errors->first('your_first_name') }}</td>
			@endif
		</tr>
	</table>
	...
	<div class="element_wrap">
		...
		<label for="gender_male"><input id="gender_male" type="radio" name="gender" value="male" {{ old('gender') === 'male' ? 'checked' : '' }} checked>男性</label>
		<label for="gender_female"><input id="gender_female" type="radio" name="gender" value="female" {{ old('gender') === 'female' ? 'checked' : '' }}>女性</label>
	</div>

	<table class="element_wrap">
		<tr>
			<td><label>メールアドレス<span>※</span></label></td>
			<td><input required type="text" name="email" value="{{ old('email') }}"></td>
		</tr>
		<tr>
			<td></td>
		...
		<tr>
			<td></td>
			@if ($errors->has('email'))
				<td class="error_message">{{ $errors->first('email') }}</td>
			@endif
		</tr>
	</table>
    ...
    <tr>
			...
			<td>
				<div class="zip_code">
					<input required id="zip_code" type="text" name="zip_code" value="{{ old('zip_code') }}">
				</div>
			</td>
    </tr>
    <tr>
		...
		<tr>
			...
			@if ($errors->has('zip_code'))
				<td class="error_message">{{ $errors->first('zip_code') }}</td>
			@endif
		</tr>
  </table>
    ...
    <tr>
			...
			<td><input required id="address" type="text" name="address" value="{{ old('address') }}"></td>
    </tr>
			<td></td>
		...
		<tr>
			...
			@if ($errors->has('address'))
				<td class="error_message">{{ $errors->first('address') }}</td>
			@endif
		</tr>
  </table>
	...
	<div class="element_wrap">
		...
		<textarea required name="contact">{{ old('contact') }}</textarea>
		<tr>
			<div>
				@if ($errors->has('contact'))
					<td class="error_message">{{ $errors->first('contact') }}</td>
				@endif
			</div>
		</tr>
	</div>
