...
<form method="get" action="<?php echo e(route('contact.find')); ?>">
	<?php echo csrf_field(); ?>
	<table class="element_wrap">
		<tr>
			...
			<td><label for="gender_male"><input id="gender_male" type="radio" name="gender" value="male" <?php echo e(old('gender') === 'male' ? 'checked' : ''); ?> >男性</label></td>
			<td><label for="gender_female"><input id="gender_female" type="radio" name="gender" value="female" <?php echo e(old('gender') === 'female' ? 'checked' : ''); ?>>女性</label></td>
		</tr>
	</table>
...
<div class="page">
	<p>全<?php echo e($contacts->total()); ?>件中 <?php echo e($contacts->firstItem()); ?>～<?php echo e($contacts->lastItem()); ?>件</p>
	<div class="pagination">
		<?php echo e($contacts->links('pagination::default')); ?>
		...
		<tr class="data_list">
			...
			<td>
				<?php if($contact->gender === 1): ?>
					男性
				<?php elseif($contact->gender === 2): ?>
					女性
				<?php endif; ?>
			</td>
			<td><?php echo e($contact->email); ?></td>
			<td class="opinion-shorten"><?php echo e(Str::limit($contact->opinion, 25, '...')); ?></td>
		</tr>
	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
</body>
</html><?php /**PATH C:\xampp\htdocs\laravelpj\resources\views/contact/admin.blade.php ENDPATH**/ ?>